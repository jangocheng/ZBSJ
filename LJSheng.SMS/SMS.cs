namespace LJSheng.SMS
{
    public class SMS
    {
        ...
        /// <param name="templatedId">短信模板id，需通过审核</param>
        ...
        public string SendSMS(string toPhone, string templatedId, string param)
        {
            ...
            string account = "511788d71a75917ef06cf410c3511fdb";    //用户sid
            string token = "6d1ecdfb7ed3b65a95d2d5d4b68839e5";      //用户sid对应的token
            string appId = "e4fdd5a912fd407bad5e7555887ff928";      //对应的应用id，非测试应用需上线使用
